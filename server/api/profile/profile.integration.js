...
describe('Profile API:', function() {
  ...
  describe('POST /api/profiles', function() {
    beforeEach(function(done) {
      request(app)
        ...
        .send({
          title: 'New Profile',
          gender: 'This is the brand new profile!!!'
        })
        .expect(201)
        .expect('Content-Type', /json/)
        .end((err, res) => {
    ...
    it('should respond with the newly created profile', function() {
      newProfile.title.should.equal('New Profile');
      newProfile.gender.should.equal('This is the brand new profile!!!');
    });
  ...
  describe('GET /api/profiles/:id', function() {
    ...
    it('should respond with the requested profile', function() {
      profile.title.should.equal('New Profile');
      profile.gender.should.equal('This is the brand new profile!!!');
    });
  ...
  describe('PUT /api/profiles/:id', function() {
    ...
    beforeEach(function(done) {
      request(app)
        ...
        .send({
          ...
          gender: 'This is the updated profile!!!'
        })
        .expect(200)
        .expect('Content-Type', /json/)
    ...
    it('should respond with the updated profile', function() {
      updatedProfile.title.should.equal('Updated Profile');
      updatedProfile.gender.should.equal('This is the updated profile!!!');
    });
